...
:-assert(fact(preco_0_7)), assert(fact(idade_0_17)), assert(fact(apressado)), assert(fact('classificacao_46_47')), assert(fact(carnes)), assert(fact(bebida_nao_incluida)), assert(fact(entregar)).
